...
class StreamsControllers {
  ...
  /// stream used to control in view itens of the components.drawer.menu
  StreamController<List<ItemHiddenMenu>> _listItensMenuController =
      StreamController<List<ItemHiddenMenu>>();

  Function(List<ItemHiddenMenu>) get setItensMenu =>
      _listItensMenuController.sink.add;

  Stream<List<ItemHiddenMenu>> get getItensMenu =>
      _listItensMenuController.stream;
  ...
  StreamController<double> _percentAnimateController =
  ...
  StreamController<double> _dragHorizontalController =
      StreamController<double>();
  ...
  /// stream used to control endrag
  StreamController<double> _positionActualEndDragController =
      StreamController();

  Function(double) get setpositionActualEndDrag =>
      _positionActualEndDragController.sink.add;

  Stream get getpositionActualEndDrag =>
      _positionActualEndDragController.stream;
